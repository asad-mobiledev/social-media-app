...
class FileServiceTestHelper {
    static func createTestImageFile(in directory: Directory) -> URL? {
        guard let baseURL = directory.url else { return nil }
        
        let testFolder = baseURL.appendingPathComponent("test")
        let testFile = testFolder.appendingPathComponent("test.jpg")
