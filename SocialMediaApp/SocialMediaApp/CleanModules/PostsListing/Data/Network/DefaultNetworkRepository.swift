...
//        guard let responseArray = try JSONSerialization.jsonObject(with: data) as? [[String: Any]] else {
//            throw CustomError.message("Unexpected response format")
//        }
//        
//        var posts: [PostDTO] = []
...
//                  let postType = (fields["postType"] as? [String: Any])?["stringValue"] as? String,
//                  let mediaName = (fields["mediaName"] as? [String: Any])?["stringValue"] as? String,
//                  let date = (fields["date"] as? [String: Any])?["stringValue"] as? String
//            else {
//                continue
//            }
//            
...
//            
//            let post = PostDTO(id: id, postType: postType, mediaName: mediaName, date: date)
//            posts.append(post)
//        }
...
//                print("Failed to fetch posts: \(message)")
//                return []
//            }
//            
//            guard let responseArray = try JSONSerialization.jsonObject(with: data) as? [[String: Any]] else {
...
//
//        } catch {
//            throw CustomError.message("Error fetching posts: \(error)")
//        }
    }
