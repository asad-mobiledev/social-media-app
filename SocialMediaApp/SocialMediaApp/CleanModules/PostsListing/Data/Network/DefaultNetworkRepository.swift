...
class DefaultNetworkRepository: NetworkRepository {
   ...
   let db = Firestore.firestore()
    ...
    func createPost(mediaType: MediaType, fileURL: URL) async throws -> PostDTO {
        ...
        let post = PostDTO(id: self.documentName!, postType: mediaType.rawValue, fileURLString: fileURL.absoluteString, date: date)
        ...
        let jsonBody: [String: Any] = [
            "fields": [
                ...
                "fileURLString": [
                    "stringValue": post.fileURL?.absoluteString
                ],
                "date": [
